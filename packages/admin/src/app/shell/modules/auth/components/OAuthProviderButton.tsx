...
import { Spinner } from "../../../layout/ui/components/Spinner.js";
...
const labelByProvider: Record<OAuthProvider, string> = {
  google: "auth.provider.google",
  github: "auth.provider.github"
};

const GoogleIcon = (): React.JSX.Element => (
  <svg aria-hidden="true" width="20" height="20" viewBox="0 0 48 48" fill="none">
    <path
...
const GitHubIcon = (): React.JSX.Element => (
  <svg aria-hidden="true" width="18" height="18" viewBox="0 0 438.55 438.55" fill="currentColor">
...
const ProviderIcon = ({ provider }: { provider: OAuthProvider }): React.JSX.Element =>
