import { startOAuthRedirect } from "../../services/http/authProviderApi.js";
    ...
    <>
      <div className="auth-card__actions">
        ...
        >
          ...
          <span className="button__label">Continue with Google</span>
        </button>
        <button
          type="button"
          className="button button--solid button--sm button--full button--has-icon auth-provider-button"
        ...
        >
          ...
          <span className="button__label">Continue with GitHub</span>
        </button>
      </div>
